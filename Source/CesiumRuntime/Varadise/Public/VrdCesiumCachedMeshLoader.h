...
public:
  UStaticMesh* LoadCachedMesh(const FString& MeshGamepath, TFunction<void()>&& FnPostLoadMesh);
...
public:
  UStaticMesh* LoadCachedMesh(const FString& MeshGamepath, TFunction<void()>&& FnPostLoadMesh, const FCesiumLoadCachedMesh_TestParams& params);
  ...
  TArray<FCesiumLoadCachedMesh_TestParams> _loadCachedMeshParams;
